...
export class Init1769605524130 implements MigrationInterface {
    name = 'Init1769605524130'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`role\` (\`role_id\` varchar(36) NOT NULL, \`role_name\` varchar(25) NOT NULL, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, UNIQUE INDEX \`IDX_4810bc474fe6394c6f58cb7c9e\` (\`role_name\`), PRIMARY KEY (\`role_id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`payment\` (\`id\` varchar(36) NOT NULL, \`amount\` decimal(15,2) NOT NULL, \`status\` varchar(25) NOT NULL, \`gateway\` varchar(25) NOT NULL, \`is_activated\` tinyint NOT NULL DEFAULT 0, \`gateway_transaction_id\` varchar(255) NULL, \`transaction_ref\` varchar(100) NOT NULL, \`currency\` varchar(255) NOT NULL DEFAULT 'VND', \`order_info\` text NULL, \`pay_url\` text NULL, \`paid_at\` datetime NULL, \`message\` text NULL, \`bankCode\` varchar(50) NULL, \`response_code\` varchar(10) NULL, \`raw_response\` longtext NULL, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`user_id\` varchar(36) NULL, UNIQUE INDEX \`IDX_f0eea471026ce4a3279bdba938\` (\`transaction_ref\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`lesson_progress\` (\`id\` varchar(36) NOT NULL, \`completed\` tinyint NOT NULL DEFAULT 0, \`lastPosition\` smallint NOT NULL DEFAULT '0', \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`userUserId\` varchar(36) NULL, \`lessonId\` varchar(36) NULL, UNIQUE INDEX \`IDX_f41858fcdbacf554115893092e\` (\`userUserId\`, \`lessonId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`category\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(100) NOT NULL, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_preference\` (\`id\` varchar(36) NOT NULL, \`desiredLevels\` text NULL, \`learningGoals\` text NULL, \`interestedSkills\` text NULL, \`userUserId\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user\` (\`user_id\` varchar(36) NOT NULL, \`full_name\` varchar(100) NOT NULL, \`email\` varchar(150) NOT NULL, \`password\` varchar(255) NOT NULL, \`phone\` varchar(15) NULL, \`date_of_birth\` date NULL, \`address\` varchar(255) NULL, \`bio\` varchar(255) NULL, \`description\` text NULL, \`is_active\` tinyint NOT NULL DEFAULT 0, \`code_id\` varchar(6) NULL, \`code_expires_at\` timestamp NULL, \`avatar\` varchar(255) NULL, \`has_preferences\` tinyint NOT NULL DEFAULT 0, \`is_disabled\` tinyint NOT NULL DEFAULT 0, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`role_id\` varchar(36) NULL, UNIQUE INDEX \`IDX_e12875dfb3b1d92d7d7c5377e2\` (\`email\`), PRIMARY KEY (\`user_id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`comment\` (\`id\` varchar(36) NOT NULL, \`content\` text NOT NULL, \`rating\` tinyint NULL, \`type\` varchar(25) NOT NULL DEFAULT 'lesson', \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`parent_id\` varchar(36) NULL, \`user_id\` varchar(36) NULL, \`course_id\` varchar(36) NULL, \`lesson_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`quiz_question\` (\`id\` varchar(255) NOT NULL, \`question\` text NULL, \`correct_option_id\` varchar(255) NULL, \`order\` smallint NOT NULL DEFAULT '0', \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`lesson_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`lesson_video\` (\`id\` varchar(36) NOT NULL, \`public_id\` varchar(255) NOT NULL, \`playback_id\` varchar(50) NULL, \`duration\` smallint NOT NULL DEFAULT '0', \`width_original\` smallint NULL, \`height_original\` smallint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`lesson\` (\`id\` varchar(255) NOT NULL, \`title\` varchar(255) NULL, \`content\` text NULL, \`duration\` smallint NULL, \`parent_id\` varchar(255) NULL, \`video_id\` varchar(255) NULL, \`order\` smallint NOT NULL DEFAULT '0', \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`chapter_id\` varchar(36) NULL, UNIQUE INDEX \`REL_ddfb00dc35a3c857190a78797a\` (\`video_id\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`chapter\` (\`id\` varchar(255) NOT NULL, \`title\` varchar(255) NULL, \`order\` smallint NOT NULL DEFAULT '0', \`parent_id\` varchar(255) NULL, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`course_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`course\` (\`id\` varchar(36) NOT NULL, \`title\` varchar(255) NULL, \`description\` text NULL, \`requirements\` longtext NULL, \`learnings\` longtext NULL, \`duration\` int NULL, \`price\` decimal(15,2) NULL, \`original_price\` decimal(15,2) NULL, \`image\` varchar(255) NULL, \`rating\` decimal(3,2) UNSIGNED NOT NULL DEFAULT '0.00', \`ratingCount\` smallint UNSIGNED NOT NULL DEFAULT '0', \`students\` smallint UNSIGNED NOT NULL DEFAULT '0', \`level\` varchar(50) NULL, \`discount\` decimal(5,2) NULL, \`discountExpiresAt\` timestamp NULL, \`status\` enum ('draft', 'pending', 'published', 'rejected ', 'archived') NOT NULL DEFAULT 'draft', \`rejection_reason\` text NULL, \`archive_reason\` text NULL, \`submission_note\` text NULL, \`is_live\` tinyint NOT NULL DEFAULT 0, \`parent_id\` varchar(255) NULL, \`has_draft\` tinyint NOT NULL DEFAULT 0, \`created_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP(), \`updated_at\` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP() ON UPDATE CURRENT_TIMESTAMP, \`category_id\` varchar(36) NULL, \`instructor_id\` varchar(36) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`user_preference_main_categories_category\` (\`userPreferenceId\` varchar(36) NOT NULL, \`categoryId\` varchar(36) NOT NULL, INDEX \`IDX_e6cb779091a50d6bc2b24a68eb\` (\`userPreferenceId\`), INDEX \`IDX_1b43e703486a864894aba9de45\` (\`categoryId\`), PRIMARY KEY (\`userPreferenceId\`, \`categoryId\`)) ENGINE=InnoDB`);
