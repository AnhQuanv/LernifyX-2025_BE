...
export class InitC1768701087566 implements MigrationInterface {
    name = 'InitC1768701087566'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`is_disabled\` tinyint NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`disabled_reason\` text NULL`);
        await queryRunner.query(`ALTER TABLE \`user\` ADD \`disabled_at\` timestamp NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`disabled_reason\``);
