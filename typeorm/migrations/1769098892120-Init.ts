...
export class Init1769098892120 implements MigrationInterface {
    name = 'Init1769098892120'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`lesson_video\` (\`id\` varchar(36) NOT NULL, \`public_id\` varchar(255) NOT NULL, \`playback_id\` varchar(255) NULL, \`duration\` int NOT NULL DEFAULT '0', \`width_original\` int NULL, \`height_original\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
